...
% (x[2n] la phien ban giam 1/2 tan so lay mau cua x[n] -> chieu dai giam di 1/2)
clear; close all;
nL = -20; nR = 10;  % sinh so bien trai & phai cua n
n = nL:nR;          % sinh vector chi so mau
minA = 0; maxA = 5; % bien do min & max amplitue
x = [linspace(minA, maxA, abs(nL)),maxA,linspace(maxA, minA,nR)];%sinh vector bien do tin hieu
